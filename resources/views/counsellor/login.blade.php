        ...
        <div class="card card-raised shadow-10 mt-5 mt-xl-10 mb-4">
            <div class="card-body p-5">
                ...
                <div class="text-center">
                    ...
                    <h1 class="display-5 mb-0">Counsellor Login</h1>
                    <div class="subheading-1 mb-5">to continue to app</div>
                </div>
                <!-- Login submission form-->
                <form action="{{url('/')}}/counsellor/dologin" method="post">
                    @csrf
                    <div class="mb-4">
                    ...
                    <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                        <a class="small fw-500 text-decoration-none" href="{{ route('counsellor.forgot_password')}}">Forgot Password?</a>
