...
@section('content')
    ...
    <div class="container-xl px-5">
        ...
        <div class="row gx-5">
            <div class="col-lg-12">
                <form action="{{route('counsellor.student.update')}}" method="post"  enctype="multipart/form-data" onsubmit="return formValidation();">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <select class="form-control" id="user_tag_id" name="user_tag_id">
                                ...
                                @foreach($user_tag_list as $value)
                                    <option value="{{$value->id}}" @if($value->id == $details->user_tag_id) selected @endif>{{$value->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                @if($details->profile_img)
                                    <img src="{{ asset('uploads/profileImage/' . $details->profile_img) }}" id="image-preview" style="width: 50px; margin-left: 10px;">
                                @else
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" id="school_name" type="text" name="school_name" placeholder=""  value="{{$details->school_name}}" />
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="class_name">Class Name </label>
                            <input class="form-control" id="class_name" type="text" name="class_name" placeholder=""  value="{{$details->class_name}}" />
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="section_name">Section Name </label>
                            <input class="form-control" id="section_name" type="text" name="section_name" placeholder=""  value="{{$details->section_name}}" />
                        </div>
                        <div class="col-sm-6">
