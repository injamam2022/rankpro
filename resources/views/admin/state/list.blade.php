...
@section('content')
    <div class="container-xl px-5">
        <div class="d-flex mt-10 mb-4" style="display:flex;">
            ...
            <div>
                <a href="{{route('admin.state.add')}}" style="display: flex;font-size: 20px;text-decoration: none !important;">
                ...
                @if(count($list)>0)
                    @foreach ($list as $key=>$row)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.state.edit',['id'=>$row->id])}}" class="btn btn-primary btn-sm mr-1"><i class="material-icons">edit</i></a>
                            </td>
                        </tr>
                    @endforeach
                @endif
