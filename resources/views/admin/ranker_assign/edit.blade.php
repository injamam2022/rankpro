...
@section('content')
    ...
    <div class="container-xl px-5">
        <div class="d-flex mt-10 mb-4 align-items-center">
            <h1 class="page-header mb-0">Edit Student Request</h1>
        </div>
        <div class="row gx-5">
            <div class="col-lg-12">
                <form action="{{route('admin.ranker_assign.update')}}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <select class="form-control" id="student_id" name="student_id">
                                ...
                                @foreach($student_list as $key => $value)
                                    <option value="{{$value->id}}" @if($details->student_id == $value->id) selected  @endif>{{$value->first_name}} {{$value->last_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="ranker_id">Ranker</label>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" id="date" type="text" name="date" placeholder=""  value="{{$details->date}}" />
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="payment_amount">Payment Amount</label>
                            <input class="form-control" id="payment_amount" type="text" name="payment_amount" placeholder=""  value="{{$details->payment_amount}}" />
                        </div>
                        <div class="col-sm-6">
