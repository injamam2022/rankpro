...
@section('content')
    ...
    <div class="container-xl px-5">
        <div class="d-flex mt-10 mb-4 align-items-center">
            <h1 class="page-header mb-0">Edit Banner</h1>
        </div>
        <div class="row gx-5">
            <div class="col-lg-12">
                <form action="{{route('admin.banner.update')}}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <label class="form-label" for="image">Banner Image (Image Size: W- 463 px, H- 263 px) (Type: PNG,JPG,JPEG) <span class="text-danger">*</span></label>
                            <div class="d-flex align-items-center">
                                ...
                                @if($banner->image)
                                    <img src="{{ asset('uploads/banner/thumbnail/' . $banner->image) }}" id="image-preview" style="width: 50px; margin-left: 10px;">
                                @else
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <textarea id="editor<?=$language->id?>" name="text_<?=$language->id?>"class="form-control" rows="5">
                                                            @php
                                                                $data = $banner->descriptions->firstWhere('language', $language->id);
                                                            @endphp
                                                            {{ $data ? $data->text : '' }}
                                                        </textarea>
                                                    </div>
