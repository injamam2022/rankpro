...
@section('content')
    ...
    <div class="container-xl px-5">
        ...
        <div class="row gx-5">
            <div class="col-lg-12">
                <form action="{{route('admin.mention.save')}}" method="post"  enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            <label class="form-label" for="image">Image (Image Size: W- 240 px, H- 86 px) (Type: PNG,JPG,JPEG) <span class="text-danger">*</span></label>
