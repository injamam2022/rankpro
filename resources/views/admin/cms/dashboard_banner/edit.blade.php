...
@section('content')
    ...
    <div class="container-xl px-5">
        <div class="d-flex mt-10 mb-4 align-items-center">
            <h1 class="page-header mb-0">Edit Dashboard Banner</h1>
        </div>
        <div class="row gx-5">
            <div class="col-lg-12">
                <form action="{{route('admin.dashboard_banner.update')}}" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input class="form-control" id="icon" type="file" name="icon"
                                       @if(!$banner->icon) required @endif
                                       onchange="previewImage(event)">

                                @if($banner->icon)
                                    <img src="{{ asset('uploads/dashboard_banner/thumbnail/' . $banner->icon) }}" id="image-preview" style="width: 50px; margin-left: 10px;">
                                @else
