...
@section('content')
    ...
    <div class="container-xl px-5">
        ...
        <div class="row gx-5">
            <div class="col-lg-12">
                <form action="{{route('admin.test_series.update')}}" method="post"  enctype="multipart/form-data">
                    <input type="hidden" name="id" id="id" value="{{$test_series->id}}">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                @if($test_series->image)
                                    <img src="{{ asset('uploads/test_series/thumbnail/' . $test_series->image) }}" id="image-preview" style="width: 50px; margin-left: 10px;">
                                @else
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                @if($test_series->icon)
                                    <img src="{{ asset('uploads/test_series/thumbnail/' . $test_series->icon) }}" id="icon-preview" style="width: 50px; margin-left: 10px;">
                                @else
                                    <img id="image-preview" style="width: 50px; margin-left: 10px; display: none;">
                                @endif
                            </div>
                        ...
                        {{-- <div class="col-sm-12">
                            ...
                            <input class="form-control" id="name" type="text" name="name" placeholder="" value="{{$test_series->name}}"  required/>
                        </div> --}}
                        ...
                        <div class="col-sm-12 mt-3">
                            ...
                            <select class="form-control" name="subjects[]" id="subjects" multiple="multiple" tabindex="-1">
                                @php
                                    $selectedSubject = [];
                                    $selectedSubject = array_merge($selectedSubject, explode(',', $test_series->subjects));
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <textarea id="editor1<?=$language->id?>" name="heading_<?=$language->id?>"class="form-control" rows="5">
                                                            @php
                                                                $heading = $test_series->headings->firstWhere('language', $language->id);
                                                            @endphp
                                        ...
                                        <label for="About" class="custom-label">About</label>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        @php
                                                            $about = $test_series->abouts->firstWhere('language', $language->id);
                                                        @endphp
                                                        {{ $about ? $about->about : '' }}
                                                        </textarea>
                                                    </div>
                                        ...
                                        <label for="description" class="custom-label">Banner Description</label>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        @php
                                                            $description = $test_series->descriptions->firstWhere('language', $language->id);
                                                        @endphp
                                        ...
                                        <label for="Overview" class="custom-label">Quick Overview</label>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        @php
                                                            $overview = $test_series->overviews->firstWhere('language', $language->id);
                                                        @endphp
                                        ...
                                        <label for="Exam" class="custom-label">Exam Description</label>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        @php
                                                            $examdesc = $test_series->examdescs->firstWhere('language', $language->id);
                                                        @endphp
                                                        {{ $examdesc ? $examdesc->examdesc : '' }}
                                                        </textarea>
                                                    </div>
                                            </div>
                                    </div>
                                        ...
                                        <label for="Marking" class="custom-label">Marking Scheme</label>
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        @php
                                                            $markscheme = $test_series->markschemes->firstWhere('language', $language->id);
                                                        @endphp
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" id="price" type="text" name="price" placeholder="" value="{{ $test_series->price ?? '' }}" />
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="dis_price">Annual Fee Discount</label>
                            <input class="form-control" id="dis_price" type="text" name="dis_price" placeholder="" value="{{ $test_series->dis_price ?? '' }}" />
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label" for="tax">Tax</label>
                            <input class="form-control" id="tax" type="text" name="tax" placeholder="" value="{{ $test_series->tax ?? '' }}" />
                        </div>
                        ...
                        <div class="col-sm-12 alert alert-success p-4 mt-4" id="language_list_view">
                            ...
                            @foreach($test_series->language as $lang)
                                <div class="row mb-3" id="language_view_{{ $language_count }}">
                                    <div class="col-11">
                                        <input type="text" class="form-control" name="language_name[]" placeholder="Enter name" value="{{ $lang->language_name }}" id="language_name_{{ $language_count }}">
                                    </div>
                        ...
                        <div class="col-sm-12 alert alert-success p-4 mt-4" id="location_list_view">
                            ...
                            @php $location_count = 0; @endphp
                            @foreach($test_series->location as $data)
                                <div class="row mb-3" id="location_view_{{ $location_count }}">
                                    <div class="col-11">
                                        <input type="text" class="form-control" name="location_name[]" placeholder="Enter name" value="{{ $data->location_name }}" id="location_name_{{ $location_count }}">
                                    </div>
                                    <div class="col-1 d-flex align-items-center">
                                        <img src="{{ asset('image/remove-box.png') }}" alt="Remove" class="cursor-pointer" onclick="removeLocation({{ $location_count }})">
                                    </div>
                                </div>
                                @php $location_count++; @endphp
                            @endforeach
                        </div>
                        ...
                        <div class="col-sm-12 alert alert-success p-4 mt-4" id="date_list_view">
                            ...
                            @php $date_count = 0; @endphp
                            @foreach($test_series->date as $data)
                                <div class="row mb-3" id="date_view_{{ $date_count }}">
                                    <div class="col-11">
                                        <input type="text" class="form-control" name="date_name[]" placeholder="Enter starting date" value="{{ $data->date_name }}" id="date_name_{{ $date_count }}">
                                    </div>
                                    <div class="col-1 d-flex align-items-center">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-control" style="display:flex;">
                                <div class="form-check">
                                    <input class="form-check-input" id="status_active" type="radio" name="status" @if($test_series->status == 1) checked  @endif value="1" />
                                    <label class="form-check-label" for="status_active">Active</label>
                                </div>
                                <div class="form-check" style="margin-left: 15px;">
                                    <input class="form-check-input" id="status_inactive" type="radio" name="status" @if($test_series->status == 0) checked  @endif value="0" />
...
<script>
    ...
    let location_count = {{ $location_count }};
