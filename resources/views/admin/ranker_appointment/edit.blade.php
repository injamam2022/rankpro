...
@section('content')
    ...
    <div class="container-xl px-5">
        <div class="d-flex mt-10 mb-4 align-items-center">
            <h1 class="page-header mb-0">Edit Ranker Appointment</h1>
        </div>
        <div class="row gx-5">
            <div class="col-lg-12">
                <form action="{{route('admin.ranker_appointment.update')}}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" id="college_name" type="text" name="college_name" placeholder=""  value="{{$details->college_name}}" />
                        </div>
                        <div class="col-sm-6">
