...
@section('content')
        <div class="container-xl px-5">
            <div class="d-flex mt-10 mb-4 align-items-center">
                <h1 class="page-header mb-0">Edit Country</h1>
            </div>
            <div class="row gx-5">
                <div class="col-lg-9">
                    <form action="{{route('admin.country.update')}}" method="post" enctype="multipart/form-data" onsubmit="return formValidation();">
                        @csrf
                        ...
                        <div id="material-textfield">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="sortname" name="sortname" type="text" placeholder=""  value="{{$details->sortname}}" />
                                @error('sortname')
                                    <div class="invalid-feedback" role="alert" style="display:block;">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="phonecode" name="phonecode" type="text" placeholder=""  value="{{$details->phonecode}}" />
                                @error('phonecode')
                                    <div class="invalid-feedback" role="alert" style="display:block;">
