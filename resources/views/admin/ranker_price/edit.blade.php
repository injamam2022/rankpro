...
@section('content')
    ...
    <div class="container-xl px-5">
        <div class="d-flex mt-10 mb-4 align-items-center">
            <h1 class="page-header mb-0">Edit Meeting</h1>
        </div>
        <div class="row gx-5">
            <div class="col-lg-12">
                <form action="{{route('admin.ranker_price.update')}}" method="post"  enctype="multipart/form-data" onsubmit="return formValidation();">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" id="title" type="text" name="title" placeholder=""  value="{{$details->title}}" />
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" id="type" type="text" name="type" placeholder=""  value="{{$details->type}}" />
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control" id="time" type="text" name="time" placeholder=""  value="{{$details->time}}" />
                        </div>
                        <div class="col-sm-6">
