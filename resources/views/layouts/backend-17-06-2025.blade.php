                        ...
                        <div class="nav">
                            ...
                            @if(isUserPermitted('exam', 'menu'))
                                ...
                                <div class="collapse" id="collapseOnlineExam" aria-labelledby="headingOne" data-bs-parent="#drawerAccordion">
                                    <nav class="drawer-menu-nested nav">
                                        <!-- <a class="nav-link {{ request()->is('admin/exam_location') ? ' active' : '' }} {{ request()->is('admin/exam_location/*') ? ' active' : '' }}" href="{{route('admin.exam_location')}}">Exam Location</a> -->
