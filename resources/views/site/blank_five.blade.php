                              ...
                              <div class="tab-content dashboardBlock">
                                <div class="tab-pane fade show active">
                                    <div class="textTitle_viewAllText">
                                        <div class="dashboardTitle dashboardTitle3">Answers <span>Analytics</span> (Physics)</div>
                                    </div>
                                    ...
                                    <div class="row resultCardRow">
                                        <div class="col-md-4 resultCardCol">
                                            <div class="result-card">
                                                ...
                                                <div class="table-wrapper topper-chart">
                                                  <img src="{{ asset('') }}web/images/topperPieImg.png" class="img-fluid topperPieImg" alt="">
                                                </div>
                                        ...
                                        <div class="col-md-4 resultCardCol">
                                            <div class="result-card">
                                                ...
                                                <div class="table-wrapper topper-chart" style="background: linear-gradient( 135deg, #6f82ff 0%, #8b6be8 35%, #b65ccf 60%, #ff4fa3 100% );">
                                                  <img src="{{ asset('') }}web/images/topperPieImg2.png" class="img-fluid topperPieImg" alt="">
                                                </div>
                                        ...
                                        <div class="col-md-4 resultCardCol">
                                            <div class="result-card">
                                                ...
                                                <div class="table-wrapper topper-chart">
                                                  <img src="{{ asset('') }}web/images/topperPieImg3.png" class="img-fluid topperPieImg" alt="">
                                                </div>
