        ...
        <div class="topbanner">
            <div class="cusContainer d-flex" style="max-width: 1420px;">
                <div class="leftText wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <!-- <h2><span class="sizeOne"> Test Series</span> – The Ultimate NEET Prep Test
                        Series
                    </h2>
                    <h3>
                ...
                @foreach ($exam as $index => $test)
                    ...
                    <div class="col-sm-6 d-flex justify-content-center">
                        <div class="testserblocks {{ $colorClass }}">
                            <div class="neetprep">
                                <img src="{{ asset('uploads/exam/' . ($test->landing_icon ?? 'default.png')) }}" class="img-fluid">

                                <p>{!! $test->name !!}</p>

                                <a href="{{ route('testseries.details', encrypt($test->id)) }}">View Course Details</a>
                            </div>
                        </div>
                    </div>
                @endforeach
