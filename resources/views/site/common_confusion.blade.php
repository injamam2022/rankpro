                                            ...
                                            <div class="reason-btnAll position-relative justify-content-start">
                                                ...
                                                <div class="dropdown-menu reason-dropdown question-box">
                                                  @foreach($mistake_input_list as $value)
                                                    ...
                                                    <!--    <input class="form-check-input" type="radio" name="reason" id="resn{{$value->id}}" @if($value->id == $reason_id) checked @endif>-->
                                                    ...
                                                    <div class="form-check option reason-item">
                                                      ...
                                                      <input class="form-check-input" type="radio" name="reason" 
                                                             id="resn{{$value->id}}"
                                                             onclick="window.location.href='{{ route('common_confusion') }}?subject_id={{$subject_id}}&exam_type={{$exam_type}}&reason_id={{$value->id}}'"
                                                             @if($value->id == $reason_id) checked @endif>
