...
<body>
                                              ...
                                              <div class="table-wrapper topper-chart">
                                                <div class="row">
                                                  <div class="col-md-6">
                                                      ...
                                                      <div class="chart-Info bg-gray" style="margin-bottom: 0px !important;">
                                                        <div>
                                                            You:
                                                        </div>
                                                        <div>
    ...
    <script>
      ...
      @if($topper_data)
        @if($topper_data->total_mark && $topper_data->totals_marks_for_exam)
      ...
      @if($you_data)
        @if($you_data->total_mark && $you_data->totals_marks_for_exam)
