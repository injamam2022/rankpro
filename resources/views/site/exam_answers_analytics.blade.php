...
<body>
                          ...
                          <div class="col-12">
                              <div class="dashboardBlock dashboardBlockShadow">
                                 <!--  <ul class="nav nav-tabs examTab" role="tablist">
                                    <li class="nav-item">
                                      <a class="nav-link @if($exam_type==1) active @endif" href="{{ route('answers_analytics') }}?subject_id={{$subject_id}}&exam_id={{$exam_id}}&exam_type=1">Online Examination</a>
                                    </li>
                                    <li class="nav-item">
                                      <a class="nav-link @if($exam_type==2) active @endif" href="{{ route('answers_analytics') }}?subject_id={{$subject_id}}&exam_id={{$exam_id}}&exam_type=2">Offline Examination</a>
                                    </li>
                                    <li class="nav-item">
                                      <a class="nav-link @if($exam_type==3 || $exam_type == '') active @endif" href="{{ route('answers_analytics') }}?subject_id={{$subject_id}}&exam_id={{$exam_id}}&exam_type=3">Overall</a>
                                    </li>
                                  </ul> -->
                                  <ul class="nav nav-tabs examTab examTabSub">
                                    @foreach($subject_list as $value)
                                        <li class="nav-item mt-2" >
                                          <a class="nav-link  @if($subject_id==$value->id) active @endif" href="{{ route('exam_answers_analytics') }}?subject_id={{$value->id}}&exam_id={{$exam_id}}&exam_type={{$exam_type}}">{{$value->name}}</a>
                                        </li>
                                    @endforeach
                                  </ul>
                              </div>
                              ...
                              <div class="tab-content dashboardBlock">
                                <div class="tab-pane fade show active">
                                                    ...
                                                    <tbody>                                                      
                                                      <tr class="row-topper text-center">
                                                        ...
                                                        <td class="fw-semibold">
                                                          @if(isset($easy_toper_list->total_mark))
                                            ...
                                            <div class="answer-summary">
                                                <div>
                                                    <div class="answer-title">
                                                      Answer Type <span class="fw-semibold">72/80</span>
                                                    </div>
                                                
                                                    <div class="answer-stats">
                                                      <span>Correct <span>20</span></span>
                                                      <span>|</span>
                                                      <span>Irrelevant <span style="color: #f20b81;">20</span></span>
                                                      <span>|</span>
                                                      <span>Silly <span style="color: #5a5a5a;">20</span></span>
                                                      <span>|</span>
                                                      <span>Wrong <span style="color: #ff0000;">20</span></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row resultCardRow">
                                        <div class="col-md-4 resultCardCol">
                                          <div class="result-card">
                                              <div class="result-card-title">Topper Vs Average Vs You</div>
                                              <div class="table-wrapper topper-chart">
                                                <div class="row">
                                                  <div class="col-md-6">
                                                      <div class="chart-Info bg-pink">
                                                        <div>
                                                            Topper:
                                                        </div>
                                                        <div>
                                                            @if($topper_data) {{(int) $topper_data->total_mark}}/{{(int) $topper_data->totals_marks_for_exam}} @endif
                                                        </div>
                                                      </div>
                                                      <div class="chart-Info bg-blue">
                                                        <div>
                                                            Average:
                                                        </div>
                                                        <div>
                                                            @if($topper_data) {{(int) $average_data->total_mark}}/{{(int) $average_data->totals_marks_for_exam}} @endif
                                                        </div>
                                                      </div>
                                                      <div class="chart-Info bg-gray">
                                                        <div>
                                                            You:
                                                        </div>
                                                        <div>
                                                            @if($topper_data) {{$you_data->total_mark}}/{{(int) $you_data->totals_marks_for_exam}} @endif
                                                        </div>
                                                      </div>
                                                  </div>
                                                  <div class="col-md-6">
                                        ...
                                        <div class="col-md-4 resultCardCol">
                                            <div class="result-card">
                                              <div class="result-card-title">Accuracy Percentage</div>
                                            
                                              <div class="table-wrapper topper-chart topperAvg-chart" style="background: linear-gradient(135deg,#6a7cff,#ff5bbd); color:#fff;">
    
                                                <div class="row">
                                                  <div class="col-4">
                                                    <canvas id="topperAcc"></canvas>
                                                    <div class="topperAvg-title">Topper</div>
                                                  </div>
                                                  <div class="col-4">
                                                    <canvas id="avgAcc"></canvas>
                                                    <div class="topperAvg-title">Average</div>
                                                  </div>
                                                  <div class="col-4">
                                                    <canvas id="youAcc"></canvas>
                                                    <div class="topperAvg-title">You</div>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 resultCardCol">
                                            <div class="result-card">
                                                <div class="result-card-title">Score</div>
                                                <div class="table-wrapper topper-chart">
                                                    <div class="row">
                                                      <div class="col-md-3">
                                                      ...
                                                      <div class="col-md-6">
                                                          <div class="singleChart-box">
                                                            <canvas id="scoreChart"></canvas>
                                                          </div>
                                                        <div class="topperAvg-title topperAvg-title2"> @if($you_data) {{$you_data->total_mark}} / {{$you_data->totals_marks_for_exam}} @endif</div>
                                                      </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
      ...
      @if($you_data)
        g_data.total_mark = {{$you_data->totals_marks_for_exam}};
        g_data.your_mark = {{$you_data->total_mark}};
      @endif
      ...
      donutChart('youAcc', g_data.you_data, '#6c757d');
        ...
        new Chart(document.getElementById('scoreChart'), {
          ...
          data: {
            datasets: [{
              data: [g_data.your_mark, g_data.total_mark-g_data.your_mark],
