                      ...
                      <div class="row">
                          <div class="col-xl-12">
                              <div class="dashboardBlock">
                                  <div class="dashboardTitle">Result</div>
                        ...
                        <div class="row">
                          @foreach($exam_result as $value)
                              <div class="col-sm-6 d-flex justify-content-center">
                                  <div class="testserblocks pink">
                                      <div class="neetprep">
                                          <img src="{{asset('uploads/exam/' . ($value->landing_icon ?? 'default.png')) }}" class="img-fluid">
                                          <p>{{$value->name}}</p>
                                          <a href="{{route('exam_result_detail',['id'=>$value->user_exam_id])}}">View Details</a>
                                      </div>
                                  </div>
                              </div>
                          @endforeach
